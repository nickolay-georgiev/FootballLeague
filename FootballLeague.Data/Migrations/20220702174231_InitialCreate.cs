        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDraw = table.Column<int>(type: "int", nullable: false),
                    ...
                    TotalSeasonPoint = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SportMatch_SportTeam_AwayTeamId",
                        column: x => x.AwayTeamId,
                        principalTable: "SportTeam",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SportMatch_SportTeam_HomeTeamId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SportTeamId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportPlayer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SportPlayer_SportTeam_SportTeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SportMatch_AwayTeamId",
                table: "SportMatch",
                column: "AwayTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_SportMatch_HomeTeamId",
                table: "SportMatch",
                column: "HomeTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_SportPlayer_IsDeleted",
                table: "SportPlayer",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_SportPlayer_SportTeamId",
                table: "SportPlayer",
                column: "SportTeamId");
        }
